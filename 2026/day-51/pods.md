...
spec:
  ...
  - name: nginx
    ...
    - containerPort: 80
```
<img width="407" height="236" alt="image" src="https://github.com/user-attachments/assets/c846118f-5dba-4e6b-a020-e564609876fc" />

Apply it:
```bash
kubectl apply -f nginx-pod.yaml
```
<img width="793" height="51" alt="image" src="https://github.com/user-attachments/assets/618ca42c-2023-463c-bf52-41fb9e8929c0" />
<img width="989" height="291" alt="image" src="https://github.com/user-attachments/assets/b3664047-6fce-4b4e-b0d2-c5ae08ee3377" />
...
```
<img width="971" height="150" alt="image" src="https://github.com/user-attachments/assets/85b6a34e-633f-42e4-b347-cded58683fdd" />
...
```
<img width="979" height="426" alt="image" src="https://github.com/user-attachments/assets/9b72931c-fbed-4d6e-baa9-1093c96e5ec5" />
<img width="1005" height="313" alt="image" src="https://github.com/user-attachments/assets/eb5e6f8b-8d1b-4f5a-8b0e-6d0681c1f103" />

```
# Read the logs
kubectl logs nginx-pod
```
<img width="1101" height="479" alt="image" src="https://github.com/user-attachments/assets/688adaff-6320-4748-ab57-2e997424018f" />
...
exit
```
<img width="1027" height="455" alt="image" src="https://github.com/user-attachments/assets/1dfb4283-8648-43ee-9e41-b7195c6b8978" />
